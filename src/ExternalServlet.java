...
public class ExternalServlet extends HttpServlet{
	...
	String redirectUri = "http://localhost:8080/ExternalServlet";
	...
	try{
		HttpGet get = new HttpGet("https://login.salesforce.com/services/oauth2/userinfo");
	...
	String name=null,email=null,usrname=null,zone=null,id=null;
	...
	try {
		JSONObject json = (JSONObject) parser.parse(result);
		 ...
		 usrname = (String)json.get("preferred_username");
		 zone = (String)json.get("zoneinfo");
		 id = (String)json.get("user_id");
	...
	if(username.equals(usrname)){
		...
		session.setAttribute("userzone",zone);
